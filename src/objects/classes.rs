...
pub struct AssemblyJsonImporter {
  ...
  pub m_Name: String,
  pub m_UserData: String,
  /// Vec<(SourceAssetIdentifier, PPtr)>: (2017.2.0b2 - 2017.2.0b10)
...
pub struct Asset {
  ...
  pub guidOfPathLocationDependencies: Option<Vec<(Enum_String__GUID, Enum_String__GUID)>>,
...
pub struct AudioImporter {
  ...
  /// Vec<(SourceAssetIdentifier, PPtr)>: (2017.2.0b2 - 2022.3.2f1)
  pub m_ExternalObjects: Option<Vec<(SourceAssetIdentifier, PPtr)>>,
  /// Vec<(i32, String)>: (3.4.0 - 3.4.2)
  pub m_FileIDToRecycleName: Option<Vec<(i32, String)>>,
  /// i32: (3.4.0 - 4.7.2)
...
pub enum Enum_Output__AudioImporterOutput {
  Output(Output), AudioImporterOutput(AudioImporterOutput)
}
...
pub enum Enum_ChildMotion__Child {
  ChildMotion(ChildMotion), Child(Child)
}
...
pub enum Enum_ClothSphereColliderPair___PPtr__PPtr {
  ClothSphereColliderPair(ClothSphereColliderPair), PPtr__PPtr((PPtr, PPtr))
}
...
pub struct CollisionModule {
  ...
  /// Vec<PPtr>: (2020.2.0b1 - 2022.3.2f1)
...
pub enum Enum_ComputeShaderVariant__ComputeShaderPlatformVariant {
  ComputeShaderVariant(ComputeShaderVariant), ComputeShaderPlatformVariant(ComputeShaderPlatformVariant)
}
...
pub enum Enum_FastPropertyName__String {
  FastPropertyName(FastPropertyName), String(String)
}
...
pub struct EditorBuildSettings {
  ...
  /// Vec<(String, PPtr)>: (2018.1.0b2 - 2022.3.2f1)
...
pub struct ExternalForcesModule {
  ...
  /// Vec<PPtr>: (2018.3.0f2 - 2022.3.2f1)
...
pub enum Enum_ComponentPair___i32__PPtr {
  ComponentPair(ComponentPair), i32__PPtr((i32, PPtr))
}
...
pub struct GraphicsSettings {
  ...
  /// Vec<(String, PPtr)>: (2021.2.0b1 - 2022.3.2f1)
...
pub enum Enum_JointAngleLimit2D__JointAngleLimits2D {
  JointAngleLimit2D(JointAngleLimit2D), JointAngleLimits2D(JointAngleLimits2D)
}
...
pub enum Enum_f32__MinMaxCurve {
  f32(f32), MinMaxCurve(MinMaxCurve)
}
...
pub struct LightingDataAsset {
  ...
  /**The name of the object.*/
  pub m_Name: String,
  /// Vec<PPtr>: (2019.1.0b1 - 2022.3.2f1)
...
pub struct LightmapSettings {
  ...
  /// PPtr: (3.5.0 - 2022.3.2f1)
  pub m_LightProbes: Option<PPtr>,
  /// PPtr: (2020.1.0b1 - 2022.3.2f1)
...
pub enum Enum_Vec_MeshBlendShape___BlendShapeData {
  Vec(Vec<MeshBlendShape>), BlendShapeData(BlendShapeData)
}
...
pub enum Enum_BoneWeights4__BoneInfluence {
  BoneWeights4(BoneWeights4), BoneInfluence(BoneInfluence)
}
...
pub enum Enum_GradientNEW__Gradient {
  GradientNEW(GradientNEW), Gradient(Gradient)
}
...
pub struct MovieImporter {
  ...
  /// String: (5.0.0f4 - 2019.2.21f1)
  pub m_AssetBundleVariant: Option<String>,
  /// Vec<(SourceAssetIdentifier, PPtr)>: (2017.2.0b2 - 2019.2.21f1)
  pub m_ExternalObjects: Option<Vec<(SourceAssetIdentifier, PPtr)>>,
  /// Vec<(i32, String)>: (3.4.0 - 3.4.2)
  pub m_FileIDToRecycleName: Option<Vec<(i32, String)>>,
...
pub struct PluginImporter {
  ...
  pub m_PlatformData: Vec<(Enum_String___String__String, PlatformSettingsData)>,
  /**Get or set any user data.*/
  pub m_UserData: String,
...
#[derive(Debug, Serialize, Deserialize)]
#[serde(untagged)]
pub enum Enum_String___String__String {
  String(String), String__String((String, String))
}
...
pub struct Prefab {
  ...
  /// PPtr: (3.5.0 - 2018.1.9f2)
  pub m_ParentPrefab: Option<PPtr>,
  /// PPtr: (2018.2.0b1 - 2018.2.21f1)
...
pub struct PrefabModification {
  ...
  /// Vec<PPtr>: (2022.2.0b1 - 2022.3.2f1)
...
pub struct ProceduralMaterial {
  ...
  /// Vec<String>: (4.1.0 - 4.7.2); String: (5.0.0f4 - 2022.1.0a16)
  pub m_ShaderKeywords: Option<Enum_Vec_String___String>,
  /// PPtr: (3.4.0 - 2017.4.40f1)
  pub m_SubstancePackage: Option<PPtr>,
  /// Vec<PPtr>: (3.4.0 - 2017.4.40f1)
...
pub struct RectTransform {
  ...
  /// Vec<PPtr>: (4.6.0 - 2022.3.2f1)
  pub m_Children: Option<Vec<PPtr>>,
  /// PPtr: (4.6.0 - 2022.3.2f1)
...
pub struct Scene {
  ...
  /// Vec<PPtr>: (3.4.0 - 3.5.7)
  pub m_PVSObjectsArray: Option<Vec<PPtr>>,
  /// Vec<PPtr>: (3.5.0 - 3.5.7)
...
pub struct ScriptedImporter {
  ...
  /**Get or set any user data.*/
  pub m_UserData: String,
  /// Vec<(SourceAssetIdentifier, PPtr)>: (2017.3.0b1 - 2022.3.2f1)
  pub m_ExternalObjects: Option<Vec<(SourceAssetIdentifier, PPtr)>>,
...
pub struct ShaderImporter {
  ...
  /// String: (5.0.0f4 - 2022.3.2f1)
  pub m_AssetBundleVariant: Option<String>,
  /// Vec<(String, PPtr)>: (4.2.0 - 2022.3.2f1)
...
pub enum Enum_f32__MultiModeParameter {
  f32(f32), MultiModeParameter(MultiModeParameter)
}
...
pub enum Enum_SpriteAtlasEditorData__SpriteAtlasAssetData {
  SpriteAtlasEditorData(SpriteAtlasEditorData), SpriteAtlasAssetData(SpriteAtlasAssetData)
}
...
pub struct TerrainData {
  ...
  /// Vec<PPtr>: (2018.4.14f1 - 2022.3.2f1)
...
pub enum Enum_TextureImporterPlatformSettings__PlatformSettings {
  TextureImporterPlatformSettings(TextureImporterPlatformSettings), PlatformSettings(PlatformSettings)
}
...
pub struct UnityPropertySheet {
  pub m_Colors: Vec<(Enum_String__FastPropertyName, ColorRGBA)>,
  pub m_Floats: Vec<(Enum_String__FastPropertyName, f32)>,
  pub m_TexEnvs: Vec<(Enum_String__FastPropertyName, UnityTexEnv)>,
...
#[derive(Debug, Serialize, Deserialize)]
#[serde(untagged)]
pub enum Enum_String__FastPropertyName {
  String(String), FastPropertyName(FastPropertyName)
}
...
pub struct VFXRenderer {
  ...
  pub m_StaticBatchInfo: StaticBatchInfo,
  pub m_StaticBatchRoot: PPtr,
  /// Vec<PPtr>: (2018.3.0f2 - 2021.1.28f1)
...
pub struct VideoClip {
  ...
  /// Vec<PPtr>: (2020.1.0b1 - 2022.3.2f1)
...
pub enum Enum_VisualEffectInfo__VisualEffectSettings {
  VisualEffectInfo(VisualEffectInfo), VisualEffectSettings(VisualEffectSettings)
}
